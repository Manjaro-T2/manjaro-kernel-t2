...
def fetch_latest_stable(url: str) -> str:
    ...
    if not candidates:
        raise RuntimeError("No active stable releases found in kernel.org response")
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Update PKGBUILD to the latest active stable kernel release.",
    )
    ...
    latest_version = fetch_latest_stable(args.releases_url)
